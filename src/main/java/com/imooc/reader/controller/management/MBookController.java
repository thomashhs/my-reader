...
public class MBookController {
    ...
    @PostMapping("/upload")
    @ResponseBody
    public Map upload(@RequestParam("img") MultipartFile file , HttpServletRequest request) throws IOException, MalformedURLException {
        //得到上传目录
    ...
    @GetMapping("/id/{id}")
    @ResponseBody
    public Map selectByBookId(@PathVariable("id") Long bookId){
        Map result=new HashMap();
    ...
    @PostMapping ("/update")
    @ResponseBody
    public Map selectByBookId(Book book){
        Map result=new HashMap();
        try {
            Book rawBook = bookService.selectBookById(book.getBookId());
    ...
    @ResponseBody
    public Map deleteByBookId(@PathVariable("id") Long bookid){
